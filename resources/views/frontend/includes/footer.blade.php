            ...
            <div class="container">
               ...
               <div class="row">
                  ...
                  <div class="col-md-3 col-sm-6 col-xs-12 ftr-follow-column pull-right">
                     ...
                     <span class="ftr-logo img"><img src="{{asset('front_end/images/ftr-logo.png')}}" class="img-responsive" alt="logo-image"></span>
                  </div>
               </div>
               <div class="footer-btm">
                  <div class="col-md-6 col-sm-6 col-xs-12 pad-left_zero pad-right_zero">
                     <p>Copyright &copy; {{ app_name() }}, {!! setting('footer_text') !!}</p>
                  </div>
                  <div class="col-md-4 col-sm-6 col-xs-12 pad-left_zero pad-right_zero pull-right">
                     <p class="text-right">Developed by: <a href="">{{ app_name() }}</a></p>
                  </div>
               </div>
            </div>
         </div>
