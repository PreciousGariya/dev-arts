...
class SliderController extends Controller
{
    ...
    public function index_data()
        ...
        $$module_name = $module_model::select('id','name','heading','description','button_1','button_2','status','updated_at');
        ...
        return DataTables::of($$module_name)
                        ...
                        ->addColumn('image', function ($data) {
                            $file= $data->getFirstMediaUrl('image', 'thumb') ? $data->getFirstMediaUrl('image', 'thumb') : '#';
                            return "<img src='$file' width='100' >";
                        })
                        ->editColumn('button_1', function ($data) {
                            return $data->button_1;
                        })
                        ->editColumn('button_2', function ($data) {
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('image') && $request->file('image')->isValid()){
            $$module_name_singular->addMediaFromRequest('image')->toMediaCollection('image');
        }
